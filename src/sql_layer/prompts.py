...
16. Все алиасы таблиц должны быть только в виде T1, T2, T3 и т.д. Назначай их строго по порядку первого появления таблиц в каждом SELECT. Другие имена алиасов использовать нельзя.
...
3️⃣ Остальное:
   ...
   - что works.work_type содержит только канонические значения;
    ...
    - что все алиасы таблиц имеют вид T1, T2, T3 и назначены по порядку появления таблиц.
